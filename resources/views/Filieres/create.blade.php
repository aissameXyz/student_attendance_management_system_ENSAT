...
<div class="container-sm">
    <form action="{{route('Filieres.store')}}" class="row g-3 needs-validation" novalidate method="POST" action="{{ route('students.store') }}">
        @csrf
        <div class="col-md-4">
            <label for="validationCustom01" class="form-label">Designation de la filiere</label>
            <input id="name" name="Designation" type="text" class="form-control" required>
