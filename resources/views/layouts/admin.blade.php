    ...
    <div class="flex-col w-full md:flex md:flex-row md:min-h-screen">
        <div @click.away="open = false"
            ...
            <nav :class="{'block': open, 'hidden': !open}"
                ...
                <x-admin-link :href="route('admin.students.index')"
                    :active="request()->routeIs('admin.students.index')">Students</x-admin-link>
                    <x-admin-link :href="route('admin.teachers.index')"
                    :active="request()->routeIs('admin.teachers.index')">Teachers</x-admin-link>
                    <x-admin-link :href="route('admin.modules.index')"
                    :active="request()->routeIs('admin.modules.index')">Modules</x-admin-link>
